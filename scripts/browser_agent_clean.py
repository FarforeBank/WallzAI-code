...
def parse_args():
    parser = argparse.ArgumentParser(description="Clean Wallz browser agent")
    ...
    parser.add_argument("--no-walls", action="store_true", help="Disable wall actions")
...
def main():
    ...
    agent = CleanWallzAgent(
        ...
        allow_walls=not args.no_walls,
        wall_fail_limit=args.wall_fail_limit,
    )
    agent.run(args.url)
